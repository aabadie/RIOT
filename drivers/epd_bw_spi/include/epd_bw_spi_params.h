...
/**
 * @brief    Waveform lookup table for a full display refresh for gde021a1.
 */
static const uint8_t epd_bw_spi_gde021a1_lut_default_full[] = {
    0x82, 0x00, 0x00, 0x00, 0xAA, 0x00, 0x00, 0x00, 0xAA, 0xAA,
    0x00, 0x00, 0xAA, 0xAA, 0xAA, 0x00, 0x55, 0xAA, 0xAA, 0x00,
    0x55, 0x55, 0x55, 0x55, 0xAA, 0xAA, 0xAA, 0xAA, 0x55, 0x55,
    0x55, 0x55, 0xAA, 0xAA, 0xAA, 0xAA, 0x15, 0x15, 0x15, 0x15,
    0x05, 0x05, 0x05, 0x05, 0x01, 0x01, 0x01, 0x01, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
/**
 * @brief    Configuration for gde021a1 e-paper display controller
 */
#define EPD_BW_SPI_CONTROLLER_GDE021A1 { \
    .vcom = 0xA8, \
    .size_x = 200, \
    .size_y = 150, \
    .lut_size = sizeof epd_bw_spi_gde021a1_lut_default_full, \
    .lut_full = epd_bw_spi_gde021a1_lut_default_full, \
    .lut_part = epd_bw_spi_gde021a1_lut_default_full, \
}
