...
This application is taken as-is from the experimental hello-world sample
application of the adaption of TensorFlow Lite for microcontrollers.
...
(.cc extensions were changed to .cpp to comply with the build system).
