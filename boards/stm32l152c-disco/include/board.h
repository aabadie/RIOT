...
/**
 * @defgroup    boards_stm32l152c-disco STM32L152C-DISCO
 * @ingroup     boards
 * @brief       Support for the STM32L476G-DISCO board
 * @{
 *
 * @file
 * @brief       Board specific definitions for the STM32L152C-DISCO board
 *
 ...
 * @{
 */
#define LED0_PIN            GPIO_PIN(PORT_B, 7)
...
#define LED1_PIN            GPIO_PIN(PORT_B, 6)
