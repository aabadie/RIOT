...
virtual COM ports, the RIOT console is connected to the **first** one
(generally mapped to `/dev/ttyACM0` on a Linux host). The second virtual COM
port (UARTE20, TX: P1.04, RX: P1.05) is available as secondary UART.
